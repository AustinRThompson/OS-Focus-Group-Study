...
demo_full <- demo_full |>
  ...
  dplyr::mutate(focus_group = as.factor(focus_group),
...
rio::export(demo_full, "Data/Prepped Data/demo_cleaned.csv")
...
demo_table <- demo_full |>
  dplyr::select(focus_group, age, gender, race, edu, years_emp_total, research_exp, region, research_percent, teaching_percent, service_percent,
                assistant_pubs, total_pubs, fam_os, use_os) |>
  dplyr::distinct() |>
  tbl_summary(
    by = focus_group,
    ...
    label = list(age ~ "Age",
                 ...
                 years_emp_total ~ "Total Years Employed",
...
research_area_table <- tbl_merge(list(Non_R1, R1)) |>
...
research_area_table |>
  gt::gtsave("Tables/research_area_table.html")
...
rm(demo_table, Non_R1, R1, research_area_table)
...
ggsave("Figures/alluvial_plot.png", plot = last_plot())
...
ggsave("Figures/research_areas.png", plot = last_plot())
...
rio::export(data_dict, "Data/Prepped Data/demo_cleaned_dictionary.csv")
